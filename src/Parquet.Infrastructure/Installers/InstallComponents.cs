...
namespace CluedIn.Crawling.Parquet.Infrastructure.Installers
{
    public class InstallComponents : IWindsorInstaller
    {
        public void Install(IWindsorContainer container, IConfigurationStore store)
        {
            container
                ...
                .Register(Component.For<IParquetClientFactory>().AsFactory())
                .Register(Component.For<ParquetClient>().LifestyleTransient());
