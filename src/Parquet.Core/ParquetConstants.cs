...
namespace CluedIn.Crawling.Parquet.Core
{
    public class ParquetConstants
    {
        ...
        public const string CrawlerDescription = "Parquet is a ... to be completed ...";
        ...
        // src\Parquet.Provider\Resources\cluedin.png
        ...
        public const string CodeOrigin = "Parquet";
        public const string ProviderRootCodeValue = "Parquet";
        public const string CrawlerName = "ParquetCrawler";
        public const string CrawlerComponentName = "ParquetCrawler";
        public static readonly Guid ProviderId = Guid.Parse("6d7f5ec4-99e3-4795-89a3-13c9e499b831");
