...
{
    public class Parquet_Command_MeshProcessor : BaseMeshProcessor
    {
        public Parquet_Command_MeshProcessor(ApplicationContext appContext)
            : base(appContext)
        {
        }

        public override Guid GetProviderId() =>
          ParquetConstants.ProviderId;
