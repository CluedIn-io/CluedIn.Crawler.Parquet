...
{
    public class DataIngestion : IClassFixture<ParquetTestFixture>
    {
        private readonly ParquetTestFixture fixture;
        private readonly ITestOutputHelper output;

        public DataIngestion(ParquetTestFixture fixture, ITestOutputHelper output)
        {
